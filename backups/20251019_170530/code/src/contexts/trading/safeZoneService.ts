    ...
    if (dayHours) {
      if (!dayHours.is24Hours) {
        if (!dayHours.open || !dayHours.close) {
          ...
          if (openTime && openTime[0] !== undefined && openTime[1] !== undefined && (openTime[0] < 0 || openTime[0] > 23 || openTime[1] < 0 || openTime[1] > 59)) {
            errors.push(`${day} open time is invalid`);
          }
          
          if (closeTime && closeTime[0] !== undefined && closeTime[1] !== undefined && (closeTime[0] < 0 || closeTime[0] > 23 || closeTime[1] < 0 || closeTime[1] > 59)) {
