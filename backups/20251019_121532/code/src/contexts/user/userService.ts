...
class UserService {
  ...
  async confirmPasswordReset(token: string, newPassword: string): Promise<void> {
    try {
      ...
      throw new Error(`Password reset confirmation failed: ${(error as Error).message}`);
    }
  }
  ...
  async regenerateDisplayName(): Promise<{ displayName: string }> {
    try {
      ...
      throw new Error(`Failed to regenerate display name: ${(error as Error).message}`);
    }
  }
  ...
  async checkDisplayNameAvailability(displayName: string): Promise<{ available: boolean }> {
    try {
      ...
      throw new Error(`Failed to check display name availability: ${(error as Error).message}`);
    }
  }
  ...
  async getVerificationDocuments(): Promise<VerificationDocument[]> {
    try {
      ...
      throw new Error(`Failed to get verification documents: ${(error as Error).message}`);
    }
  }
  ...
  async updateAvatar(avatarData: {
    ...
    try {
      ...
      throw new Error(`Failed to update avatar: ${(error as Error).message}`);
    }
  }
  ...
  async getAvatar(userId: string): Promise<{ avatarUrl: string }> {
    try {
      ...
      throw new Error(`Failed to get avatar: ${(error as Error).message}`);
    }
  }
  ...
  async getPublicProfile(userId: string): Promise<UserProfile> {
    try {
      ...
      throw new Error(`Failed to get public profile: ${(error as Error).message}`);
    }
  }
